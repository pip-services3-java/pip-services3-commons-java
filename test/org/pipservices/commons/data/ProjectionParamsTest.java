...
//    {
//		ProjectionParams parameters = ProjectionParams.fromValue(new String[] { new String("field1"), new String("field2"), new String("field3") });
//
//		assertEquals(3, parameters.size());
//        assertEquals("field1", parameters.get(0));
//        assertEquals("field2", parameters.get(1));
...
//    {
//		ProjectionParams parameters = ProjectionParams.fromValues("object1(field1)", "object2(field1, field2)", "field3");
//
...
//    {
//    	ProjectionParams parameters = ProjectionParams.fromValues("object1(field1, object2(field1, field2, field3, field4), field3)", "field2");
//
...
//        assertEquals("object1.field1", parameters.get(0));
//        assertEquals("object1.object2.field1", parameters.get(1));
//        assertEquals("object1.field3", parameters.get(3));
//        assertEquals("field2", parameters.get(4));
//    }
//	
//	@Test
//	public void convertParametersFromMultipleGroupedValues3()
//    {
//		ProjectionParams parameters = ProjectionParams.fromValues("object1(field1, object2(field1, field2, object3(field1), field4), field3)", "field2");
//
//		assertEquals(7, parameters.size());
//		assertEquals("object1.field1", parameters.get(0));
//		assertEquals("object1.object2.field1", parameters.get(1));
...
//    {
//		ProjectionParams parameters = ProjectionParams.fromValues("object1(object2(object3(field1)), field2)", "field2");
//
//		assertEquals(3, parameters.size());
...
//    {
//		ProjectionParams parameters = ProjectionParams.fromValues("field1,object1(field1),object2(field1,field2),object3(field1),field2,field3");
//
//		assertEquals(7, parameters.size());
//		assertEquals("field1", parameters.get(0));
